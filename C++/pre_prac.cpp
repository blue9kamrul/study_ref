...
int main(){
    ...
    //we are setting the decimal values that will be printed after the decimal point
    cout<<"double data : "<<setprecision(2)<<fixed<< d<<endl;
    ...
    int w;
    double z;
    ifs>>w>>z; //reading from 3.txt file
    //printing in 1.txt file
    of<<w <<" "<<z<<endl;
    //printing in console . but why not happening????
    //because of freopen is in use.. thats why its not showing in console at all. rather is being printed in out.txt file.
    cout<<w<<" "<<z<<endl;

    //files should be closed after operation
    ifs.close();
    of.close();
    of2.close();
} 